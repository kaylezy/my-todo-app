...
function app() {
  ...
  return mk("div", { id: "app" }, [
    mk("h1", null, ["Todo App: A simple app to track your todos"]),
  ...
  function createTodo(todo) {
    ...
    item = mk(
      ...
      {
        className: "todo-item",
        style: "display: flex;place-items: center;padding-bottom: 4px;",
      },
      [
        (text = mk("span", { style: "flex: 1;", ondblclick: edit }, [
          todo.text,
        ])),
...
document.body.prepend(
  mk(
    ...
    {
      style:
        "position: fixed; bottom: 0; left: 0; background: #333; color: #fff; padding: 1rem; display: flex; place-items: center;gap: 4px;",
    },
    [
      mk(
        "button",
